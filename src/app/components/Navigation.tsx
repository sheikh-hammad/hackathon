...
const Navigation = () => {
  ...
  {/* Top Bar */}
  <div className="bg-[#272343] h-[45px] flex items-center justify-between px-4 sm:px-10 lg:px-20 2xl:px-[300px]">
    <div className="flex items-center gap-2">
      ...
      <p className="font-inter text-[13px] text-white leading-[110%]">
        Free shipping on all orders over $50
      </p>
    </div>
    <div className="flex gap-6 font-inter text-white">
  ...
  {/* Middle Bar */}
  <div className="flex justify-between items-center px-4 sm:px-10 lg:px-20 2xl:px-[300px] h-[84px] bg-[#F0F2F3]">
    <div className="flex items-center gap-2">
      <div className="relative">
        <Image src="/asset/Vector (6).png" alt="" width={40} height={23.34} />
        <div className="absolute bottom-[15px] left-[6.5px]">
          <Image src="/asset/Vector (5).png" alt="" width={26.67} height={23.33} />
        </div>
      </div>
      <p className="font-inter font-medium text-[26px] leading-[120%] text-[#272343]">
        Comforty
    ...
    <div className="flex">
      <div className="bg-white flex items-center gap-3 h-[44px] rounded-[8px] px-[16px]">
        <Link href="/cart" className="flex items-center gap-2">
          ...
          <p className="text-[12px] font-inter leading-[110%]">Cart</p>
        </Link>
        <div className="flex items-center justify-center w-5 h-5 text-[10px] text-white bg-[#007580] rounded-full">
          2
        </div>
      </div>
    </div>
  ...
  {/* Bottom Bar */}
  <div className="h-[74px] flex justify-between items-center px-4 sm:px-10 lg:px-20 2xl:px-[300px]">
    <ul className="flex gap-8 text-[14px] font-inter leading-[110%]">
      <li className="text-[#007580]">
        <Link href="/">Home</Link>
      </li>
    ...
    <Link href="/contact" className="flex gap-2">
      ...
      <p className="text-[#272343] font-medium text-[14px]">(808) 555-0111</p>
    </Link>
  </div>
</nav>

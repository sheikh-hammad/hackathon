...
// // import { notFound } from "next/navigation"; // To handle 404 if the ID is not found
...
// //   if (!product) {
// //     notFound(); // Handle 404 if no product found
// //   }
...
// import { Prod, Prods } from "../../components/data/types";
...
//   const getProduct = () => {
//     const productId = allParams.id;
//     console.log(productId);
//     if (!productId) return;
//     const product = Prods.find((d) => d?.id === productId);
//     if (!product) notFound();
//     return product;
//   };
...
export default function ProductPage({ params }: { params: { id: string } }) {
  ...
  if (!product) {
    notFound(); // Returns a 404 page if the product isn't found
  }
